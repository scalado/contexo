...
#------------------------------------------------------------------------------
    def __init__(self, codeModulePaths = list(), failOnMissingHeaders = False, tolerateMissingHeaders = False, archPath = list() , additionalIncDirs = None, legacyCompilingMod = False):
