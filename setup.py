...
if sys.platform == 'win32':
	interestingfiles = ['ctx.bat', 'ctx.py',  'git-ctx.py', 'git-ctx.bat', 'msvc.py', 'msvc.bat', 'tengiltests.py']
else:
	interestingfiles = ['ctx', 'ctx.py',  'git-ctx', 'git-ctx.py', 'tengiltests.py']
...
setup(name="Contexo",
      ...
      scripts =  ['contexo/cmdline/ctx.py', 'contexo/cmdline/git-ctx.py', 'contexo/cmdline/git-ctx', 'contexo/cmdline/ctx', 'contexo/cmdline/ctx.bat', 'contexo/cmdline/bdef2rspec.py', 'contexo/plugins/export/msvc.py', 'contexo/plugins/export/tengiltests.py' ],
      ...
      packages = [ 'contexo.defaults', 'contexo' ,  'contexo.platform', 'contexo.plugins', 'contexo.plugins.export', 'colorama' ],
